...
export function NewAdminForm() {
  ...
  function submit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const res = await createAdminAction({ username, fullName, password: password || undefined });
      if (res.ok) {
        setMessage({
          kind: "ok",
          text: `Created. Temporary password: ${res.data!.tempPassword}. They'll set their own at first sign-in.`,
        });
        setUsername("");
        setFullName("");
        setPassword("");
